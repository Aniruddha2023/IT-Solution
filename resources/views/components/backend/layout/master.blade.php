...
<ul class="list-unstyled">
	...
	<li  class="list-group-item"> <form action="{{ route('logout') }}" method="POST"> @csrf<button type="submit"><i class="feather icon-log-out m-r-5"></i>Logout</button></form></li>
</ul>
</div>
</div>
...
<a href="#!" class="nav-link "><span class="pcoded-micon"><i class="feather icon-layout"></i></span><span class="pcoded-mtext">Services</span></a>
<ul class="pcoded-submenu">
	<li><a href="{{ route('add.service') }}" target="_blank">Add Service</a></li>
	<li><a href="{{ route('all.services') }}" target="_blank"> All services</a></li>
</ul>
</li>
<li class="nav-item pcoded-menu-caption">
