      ...
      <div id="heroCarousel" class="container carousel carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          <div class="carousel-container">
            <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Ekopii</span></h2>
            <p class="animate__animated animate__fadeInUp">Better Solutions For Your Business</p>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-lg-4 d-flex align-items-stretch" data-aos="fade-up">
              <div class="icon-box icon-box-blue">
                ...
                <p class="description">{{ $service->service_long_description }}</p>
              </div>
            </div>
            @endforeach
            ...
            {{-- <div class="col-md-6 col-lg-4 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
              <div class="icon-box icon-box-blue">
                <div class="icon"><img src="{{ asset("frontend/assets/img/Digital Marketing.png") }}" alt="" style="width: 45px"></div>
